    ...
    <div id="main">
        <div class="wrapper indent">
                <div class="inside">
                        ...
                        <div align="center">
                        Si ya tiene usuario y olvidó la clave de clic en <a href="RestauraClave.php">Reiniciar Clave</a>.&nbsp;En el momento no se pueden agregar usuarios por encontrarse en fase de desarrollo, si requiere información puede escribir un email a urbano.gomez@upb.edu.co
                        </div>
                    </div>
