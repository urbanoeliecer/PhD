...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST['Vendidos'])) {
            echo '<h1 style="text-align: center">Animales Vendidos</h1>';
            echo '<div class="col-lg-offset-1 col-lg-10">';
            DibujarTabla("t_animalesvend", $_SESSION['idorg'],'');
        } else {
            echo '<h1 style="text-align: center">Animales Muertos</h1>';
            echo '<div class="col-lg-offset-1 col-lg-10">';
            DibujarTabla("t_animalesmuert", $_SESSION['idorg'],'');
        }
        echo '</div>';
        ?>
    </div> <!-- /container -->
