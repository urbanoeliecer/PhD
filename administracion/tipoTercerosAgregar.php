    ...
    <body>
        ...
        <div class="container">
            <div class="col-lg-offset-3 col-lg-6">
                <?php
                $tabla = "t_tipostercero";
                if (isset($_SESSION['id'])) {
                    $id = $_SESSION['id'];
                    echo '<br/><br/><h1 style="text-align: center">Editar Tipo de Tercero</h1>';
                    generarTablaEditar($tabla, $idorg, $id, $_SESSION['idorg']);
                } else {
                    echo '<br/><br/><h1 style="text-align: center">Agregar Tipo de Tercero</h1>';
