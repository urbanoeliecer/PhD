...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <br/><br/><h1 style="text-align: center">Listado de Fincas</h1>
            <div class="col-lg-offset-1 col-lg-10">
                <?php
                DibujarTabla("t_fincas", $_SESSION['idorg'],'');
                if ($_SESSION['IdPerfil'] <= 2) {
                    //if (validarLicenciaUbicaciones($_SESSION['IdLicencia'], $_SESSION['id'])) 
                    {
