...
<html lang="es">
    <head>
        ...
        <title>SAMII-DSS - Terceros</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="Manual.php?id=4" target="_blank"><img src = "../images/descarga.png" width="33"></a>
                    ...
                    <a class="navbar-brand" href="#">SAMII-DSSs</a>
                </div>
        ...
        <div class="container">
            <br/><br/><h1 style="text-align: center">Terceros</h1>
            <div class="col-lg-offset-1 col-lg-10">
                <?php
                DibujarTabla("t_terceros", $_SESSION['idorg'],'');
