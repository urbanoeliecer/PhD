...
$ssql = "select distinct(p.idorg),  o.orgnmb, o.idusuario, max(p.tiempo) as tmp, max(p.dinero) as dnr from partidaestdnr p, t_organizaciones o where p.dinero > 2000000 and o.idorg = p.idorg group by p.idorg order by dnr desc,tmp desc";
